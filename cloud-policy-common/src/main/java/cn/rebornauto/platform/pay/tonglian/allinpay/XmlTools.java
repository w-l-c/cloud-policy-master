...
import cn.rebornauto.platform.pay.tonglian.aipg.payreq.Process;
import cn.rebornauto.platform.pay.tonglian.allinpay.security.CryptInf;
import cn.rebornauto.platform.pay.tonglian.allinpay.security.CryptNoRestrict;
import cn.rebornauto.platform.pay.tonglian.allinpay.security.CryptUnderRestrict;
...
public class XmlTools
{
	...
	public static String buildXmlForBatch(AIPG o,boolean isreq)
	{
		Process process = new Process();
		String xml = "<?xml version=\"1.0\" encoding=\"GBK\"?>"+process.formXML(o);
		xml=xml.replaceAll("__", "_");
		return xml;
	}
	
	public static String buildXml2(Object o,boolean isreq)
	{
		XStreamIg xs=new XStreamIg();
		XSUtilEx.initXStream2(xs, isreq);
		String xml = "<?xml version=\"1.0\" encoding=\"GBK\"?>"+xs.toXML(o);
		xml=xml.replaceAll("__", "_");
		return xml;
	}
