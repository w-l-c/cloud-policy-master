...
@Table(name = "`t_signature_channel`")
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class SignatureChannel implements Serializable {
    /**
     * 签章通道id
     */
    @Id
    ...
    public String toString() {
        ...
        sb.append(", signatureName=").append(signatureName);
    ...
    public boolean equals(Object that) {
        ...
        SignatureChannel other = (SignatureChannel) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getSignatureName() == null ? other.getSignatureName() == null : this.getSignatureName().equals(other.getSignatureName()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getSignatureName() == null) ? 0 : getSignatureName().hashCode());
