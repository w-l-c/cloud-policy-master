...
@Table(name = "`t_signature_channel_config`")
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class SignatureChannelConfig implements Serializable {
    @Id
    @Column(name = "`id`")
     ...
     * 签章通道id
     */
    @Column(name = "`signature_channel_id`")
    private Integer signatureChannelId;

    /**
     * 参数key   比如请求url、私钥、开发者ID、盖章的位置等等
     */
    @Column(name = "`key_`")
    private String key;
    ...
    public String toString() {
        ...
        sb.append(", signatureChannelId=").append(signatureChannelId);
    ...
    public boolean equals(Object that) {
        ...
        SignatureChannelConfig other = (SignatureChannelConfig) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getSignatureChannelId() == null ? other.getSignatureChannelId() == null : this.getSignatureChannelId().equals(other.getSignatureChannelId()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getSignatureChannelId() == null) ? 0 : getSignatureChannelId().hashCode());
