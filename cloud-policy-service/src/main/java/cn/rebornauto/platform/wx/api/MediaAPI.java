...
import cn.rebornauto.platform.wx.enums.MediaType;
import cn.rebornauto.platform.wx.message.Article;
import cn.rebornauto.platform.wx.response.BaseResponse;
import cn.rebornauto.platform.wx.response.DownloadMediaResponse;
import cn.rebornauto.platform.wx.response.UploadImgResponse;
import cn.rebornauto.platform.wx.response.UploadMediaResponse;
import cn.rebornauto.platform.wx.util.JSONUtil;
import cn.rebornauto.platform.wx.util.NetWorkCenter;
import cn.rebornauto.platform.wx.util.StreamUtil;
