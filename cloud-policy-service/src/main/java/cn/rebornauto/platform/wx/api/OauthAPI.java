...
import cn.rebornauto.platform.wx.enums.OauthScope;
...
public class OauthAPI extends BaseAPI {
     ...
     * @return token对象
     */
    public OauthGetTokenResponse getToken(WxApiConf wxApiConf,String code) {
        BeanUtil.requireNonNull(code, "code is null");
        OauthGetTokenResponse response = null;
        String url = BASE_API_URL + "sns/oauth2/access_token?appid=" +wxApiConf.getAppid()+ "&secret=" +wxApiConf.getAppsecret()+ "&code=" + code + "&grant_type=authorization_code";
